...
// Currently untested and may not be properly supported at this time.
//XanCraft21_ST7687 tft = XanCraft21_ST7687(CS_PIN, DC_PIN, MOSI_PIN, SCLK_PIN, LCK_PIN, WR_PIN);

// Option 2: must use the hardware SPI pins 
// (for UNO thats sclk = 13 and sid = 11) and pin 10 must be 
// an output. This is much faster - also required if you want
// to use the microSD card (see the image drawing example)
XanCraft21_ST7687 tft = XanCraft21_ST7687(&SPI, CS_PIN, DC_PIN, LCK_PIN, WR_PIN);
...
void setup() {
  ...
  // The commented out functions are not currently supported by this library.
  // They will be added over time, do not use them yet.
